    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_home', models.ForeignKey(blank=True, help_text='العنوان الشخصي للموظف (Partner شخصي لا يتبع الشركة).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employee_home_address', to='base.partner')),
        ...
        migrations.AddIndex(
            model_name='department',
            index=models.Index(fields=['company', 'parent'], name='hr_departme_company_97a057_idx'),
        ),
        migrations.AddIndex(
            model_name='department',
