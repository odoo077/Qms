...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['active'], name='user_active_e4b864_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['is_active', 'date_joined'], name='user_is_acti_0fb501_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='partner',
            index=models.Index(fields=['name'], name='partner_name_400a92_idx'),
        ),
        migrations.AddIndex(
            model_name='partner',
            index=models.Index(fields=['display_name'], name='partner_display_d7424d_idx'),
        ),
        migrations.AddIndex(
            model_name='partner',
            index=models.Index(fields=['company_type'], name='partner_company_f4018f_idx'),
        ),
        migrations.AddIndex(
            model_name='partner',
            index=models.Index(fields=['type'], name='partner_type_b63f1d_idx'),
        ),
        migrations.AddIndex(
            model_name='partner',
            index=models.Index(fields=['active'], name='partner_active_601d37_idx'),
        ),
        migrations.AddIndex(
            model_name='partner',
            index=models.Index(fields=['parent_company', 'company_type', 'type'], name='partner_parent__6a4bcd_idx'),
        ),
        migrations.AddConstraint(
            model_name='partner',
