    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('companies', models.ManyToManyField(blank=True, related_name='users', to='base.company')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user_default_company', to='base.company', verbose_name='Company')),
            ],
            options={
                'db_table': 'user',
        ...
        migrations.AddConstraint(
            model_name='partner',
            constraint=models.CheckConstraint(condition=models.Q(('parent__isnull', True), ('is_company', True), ('company', models.F('parent_company')), _connector='OR'), name='partner_parent_company_match', violation_error_message='Parent and child must belong to the same company (except company-to-company).'),
        ),
        migrations.AddConstraint(
            model_name='partner',
