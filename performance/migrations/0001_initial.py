    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.CheckConstraint(condition=models.Q(('score_pct__gte', 0), ('score_pct__lte', 100)), name='chk_param_result_score_0_100')],
        ...
        migrations.AddConstraint(
            model_name='evaluationparameter',
            constraint=models.UniqueConstraint(condition=models.Q(('code', ''), _negated=True), fields=('template', 'code'), name='perf_param_template_code_uniq'),
        ),
        migrations.AddIndex(
